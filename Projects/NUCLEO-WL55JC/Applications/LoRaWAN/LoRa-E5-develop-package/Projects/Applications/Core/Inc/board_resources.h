...
/**
  * @brief Pin of Led1
  */
#define SYS_LED1_PIN                                GPIO_PIN_5
/**
  * @brief Port of Led1
  */
...
/**
  ...
  */
#define SYS_BUTTONx_GPIO_CLK_ENABLE(__INDEX__)     SYS_BUTTON1_GPIO_CLK_ENABLE()

/**
  * @brief Disable all Buttons clock
  */
#define SYS_BUTTONx_GPIO_CLK_DISABLE(__INDEX__)    SYS_BUTTON1_GPIO_CLK_DISABLE()
